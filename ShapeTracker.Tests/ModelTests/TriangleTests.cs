...
namespace ShapeTracker.Tests
{
  ...
  public class TriangleTests
  {
    ...
    {
      Triangle newTriangle = new Triangle(2, 3, 8); //Update for every  Side
    ...
    public void GetSide1_ReturnsSide1_Int()
    {
      // Arrange
      int length1 = 3;
      Triangle newTriangle = new Triangle(length1, 2, 8); // Update every side
      // Act
    ...
    {
      // Arrange
      Triangle newTriangle = new Triangle(3, 3, 8); // Update every side
      int newLength1 = 44;
      // Act
    ...
    public void GetSide2_ReturnsSide2_Int()
    {
      // Arrange
      int length2 = 3;
      Triangle newTriangle = new Triangle(2, length2, 8); // Update when add side
      // Act
